      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="w-fit">
          ...
          <Link
            ...
            target="_blank"
            className="flex items-center hover:scale-105 group duration-500 transition-all ease-in-out gap-2 rounded bg-black text-white px-4 py-2"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              ...
              fill="#ffffff"
              viewBox="0 0 256 256"
              className="group-hover:scale-110 duration-300 ease-linear transition-all"
            >

...
const BookingSession = ({
  ...
  return (
    <ContainerContent url="">
      <div className="content mx-auto mt-4 h-fit space-y-8">
        <div className="flex w-full flex-col gap-4 rounded-xl bg-white">
          ...
          >
            <div className="details-booking flex w-full flex-col gap-2 rounded-xl border border-bordersolid p-6">
              ...
              <label htmlFor="selected_program" className="">
                ...
                <input
                  ...
                  disabled
                  value={getData?.title}
                  className="h-10 w-full rounded-lg border border-bordersolid bg-black/5 px-4 font-medium capitalize outline-none focus:outline-2 focus:outline-black"
                />
              </label>
                ...
                {params.slug !== "32" ? (
                  <>
                    <select
                      ...
                      className="peer h-10 w-full rounded-lg border border-bordersolid bg-foreground px-4 font-medium capitalize outline-none focus:outline-2 focus:outline-black"
                    >
            ...
            <div className="flex w-full flex-col gap-2 rounded-xl border border-bordersolid p-6">

  ...
  return (
    ...
    >
      <div className="hightlight-program-section relative grid h-fit w-full items-start justify-start rounded-xl bg-primary p-8 text-white md:grid-cols-2 md:gap-8">
        ...
        <div className="details relative z-20 flex h-full flex-col items-start justify-between">
        ...
        <div className="order-first mt-6 h-[300px] w-full max-w-[300px] xl:order-last xl:mt-0 xl:h-[400px]">

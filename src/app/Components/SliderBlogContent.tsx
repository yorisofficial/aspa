      ...
      >
        {data?.map((item, index) => (
          <SwiperSlide key={index} className="group h-full w-fit">
            ...
            >
              <div className="h-[200px] w-full overflow-hidden md:h-[250px] xl:h-[350px]">
                <Image
                  src={item.jetpack_featured_media_url}
                  alt={item.title.rendered}
                  height={1400}
                  width={1000}
                  className="max-w-1/2 aspect-16/9 h-[180px] object-cover duration-300 ease-linear group-hover:scale-110 md:h-[250px] xl:h-[350px]"
                />
              </div>

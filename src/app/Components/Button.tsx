...
const Button: React.FC<Props> = ({className, label, children, onClick, variant}) => {
  const buttonStyle = {
    primary:
      "px-4 text-sm md:text-base hover:bg-slate-600 font-semibold md:px-6 py-3 border-2 hover:scale-105 duration-300 border-primary bg-primary text-white",
    invert:
      "px-4 text-sm md:text-base font-semibold md:px-6 py-3 border-2 hover:scale-105 duration-300 border-white bg-white text-primary",
    border:
    ...
    iconPrimary:
      "flex justify-center hover:bg-slate-600 items-center gap-3 pl-3 pr-6 py-3 bg-primary text-white",
  }
